...
- **larger battery:** Allows for longer life time between charging cycles
...
| ------- | ---- | ------ | ------- |
| 1.0 | Feb 2026 | Sam | Initial document created |
...
- Begin hardware prototyping (breadboard protoype)
